...
import { createAssistant, updateUser, type State } from "@/app/assistants/lib/actions"
...
export function EditForm({ initialData }: EditFormProps) {
    ...
    const [state, formAction] = useActionState(
        initialData
            ? (prevState: State, formData: FormData) => updateUser(initialData.id, prevState, formData)
            : createAssistant,
        initialState,
    )
